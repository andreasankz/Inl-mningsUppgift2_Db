...
namespace DataAccessLibrary.Data
{
    public static class SqliteContext
    {
        ...
        public static async Task StartSQLite(string databaseName = "sqlitedatabase.db")
        {
        ...
        //public static async Task UpdateCustomer(Customer newCustomer)
        //{
        //    using (var db = new SqliteConnection(_dbpath))
        //    {
        //        db.Open();

        //        var existingCustomer = db.Query<Customer>("SELECT Name FROM Customers WHERE Id = ?", newCustomer.Name).FirstOrDefault();
        //        if (existingCustomer != null)
        //        {
        //            existingCustomer.Name = newCustomer.Name;

        //            await db.Update(existingCustomer);
        //        }
        //    }
